...
(function()
{
    ...
    var imageData;
    var imagePosition;
    var min_w = localStorage.getItem('width');
    var min_h = localStorage.getItem('height');
    var showButton = false;
    var suppressButton = false;
    var _debug_mode = false;
    
    function debug(msg){
        if (_debug_mode) console.error(msg);
    }
    ...
    function buttonClick(){
        browser.runtime.sendMessage({type: 'save', data: imageData});
    }
